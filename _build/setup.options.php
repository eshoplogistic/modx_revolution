...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        ...
        $exists2 = $modx->getObject('transport.modTransportPackage', array('package_name' => 'miniShop2'));
        break;
...
if (!$exists) {
    switch ($modx->getOption('manager_language')) {
        case 'ru':
            $output = 'Этот компонент требует <b>pdoTools</b>.<br/>Он будет автоматически скачан и установлен.';
            break;
        default:
            $output = 'This component requires <b>pdoTools</b>.<br/><br/>It will be downloaded and installed automatically.';
    }
}
if (!$exists2) {
    switch ($modx->getOption('manager_language')) {
        case 'ru':
            $output = 'Этот компонент требует <b>miniShop2</b>.<br/>Он будет автоматически скачан и установлен.';
            break;
        default:
            $output = 'This component requires <b>miniShop2</b>.<br/><br/>It will be downloaded and installed automatically.';
    }
}
