...
$sources = array(
	...
	'minishop2-custom-delivery' => $root . 'core/components/minishop2/custom/delivery/',
	'minishop2-custom-order' => $root . 'core/components/minishop2/custom/order/',
);
unset($root);
...
$vehicle->resolve('file', array(
    'source' => $sources['minishop2-custom-delivery'],
    'target' => "return MODX_CORE_PATH . 'components/minishop2/custom/';",
));

$vehicle->resolve('file', array(
    'source' => $sources['minishop2-custom-order'],
    'target' => "return MODX_CORE_PATH . 'components/minishop2/custom/';",
));
