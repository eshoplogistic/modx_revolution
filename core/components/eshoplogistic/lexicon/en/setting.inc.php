...
$_lang['setting_eshoplogistic_frontend_css'] = 'СCSS-файл для фронта';
...
$_lang['setting_eshoplogistic_orderprefix'] = 'Префикс номера заказа';
$_lang['setting_eshoplogistic_orderprefix_desc'] = '';
$_lang['setting_eshoplogistic_payment_on'] = 'Учитывать способ оплаты';
$_lang['setting_eshoplogistic_payment_on_desc'] = 'Укажите «Да», если при расчёте стоимости доставки в ваших правилах у вас учитывается способ оплаты.';